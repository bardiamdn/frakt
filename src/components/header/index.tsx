...
export default function Header() {
  return (
    <header className="w-full bg-background-accent flex items-center py-[20px] px-[50px] justify-between sticky top-0">
      <SidebarTrigger />
      {/* <svg
          width="25"
          height="25"
  ...
  return (
    <div className=" relative w-[500px]">
      ...
      <input
        ...
        aria-label="Search"
        className="bg-background rounded-full w-full h-10 pl-[50px] pr-[10px] border focus:outline-none focus:ring-2 focus:ring-primary"
      />
    </div>
  );
};
